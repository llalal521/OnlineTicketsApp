...
export default class PassByFilterModal extends Component{
    constructor(props) {
        super(props);
        this.state={
            start:[],//index
                    ...
                    <ScrollView>
                        ...
                        <Button type="ghost" style={{
                            ...
                            this.setState({
                                ...
                                console.log(this.state.start.length,this.state.end.length,this.state.startTime.length,this.state.endTime.length)
