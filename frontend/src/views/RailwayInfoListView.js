...
export default function RailwayInfoListView({route, navigation}) {
    const {isOneWay, start, end, date, returnDate,isChange,passengers,onlyHighSpeed} = route.params
                ...
                <View style={{height: 51, backgroundColor: 'white', borderColor: 'white'}}>
                    ...
                    >
                        ...
                        <TabBar.Item
                            ...
                            title="耗时排序"
                            ref={generateTestHook("RailInfoList.TimeSort")}
                        />
                        <TabBar.Item
