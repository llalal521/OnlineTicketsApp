...
import PassByList from "../components/PassByList";
import PassByFilterModal from "../components/PassByFilterModal";


export const StationContext= React.createContext({});

export default function PassByView({route, navigation}) {
    ...
    return (
        <View style={{height: '100%'}}>
            ...
            <View style={{flex: 1}}>
                ...
                <PassByList style={{flex: 1}} date={startDate}
